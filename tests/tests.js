...
describe('pricing', () => {
  ...
  describe('getEmployerContribution', () => {
    ...
    it('returns the calculated contribution (percent of price) when the contribution type is a percentage', () => {
      const contribution = pricing.getEmployerContribution(products.voluntaryLife.employerContribution, 100)
  ...
  describe('calculateVolLifePricePerRole', () => {
    it('returns the price of vol life coverage for a particular role (ee) without employer contribution', () => {
